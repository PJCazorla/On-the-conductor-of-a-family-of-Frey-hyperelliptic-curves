...
**              the main result of the article over the number
**              K = Q(zeta_r + zeta_r^{-1}),
**              thereby computing the conductor of the curve
**                  C : y^2 = F(x),
**              over K, for several parameters of z and s.
**              
...
for i in [1..nCases] do
    ...
    */
	...
	/* Firstly, we check that the primes of bad reductions are precisely
	   ...
	   the integer primes dividing the norm of the conductor are precisely
	   those corresponding to 2, r and delta. */
